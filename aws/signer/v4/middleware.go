...
func AddUnsignedPayloadMiddleware(stack *middleware.Stack) error {
	return stack.Build.Add(middleware.After, &unsignedPayload{})
}
...
func AddComputePayloadSHA256Middleware(stack *middleware.Stack) error {
	return stack.Build.Add(middleware.After, &computePayloadSHA256{})
}
...
func AddContentSHA256HeaderMiddleware(stack *middleware.Stack) error {
	return stack.Build.Insert(computePayloadHashMiddlewareID, middleware.After, &contentSHA256Header{})
}
