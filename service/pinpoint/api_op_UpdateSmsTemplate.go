...
func (c *Client) UpdateSmsTemplate(ctx context.Context, params *UpdateSmsTemplateInput, optFns ...func(*Options)) (*UpdateSmsTemplateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateSmsTemplate", params, optFns, addOperationUpdateSmsTemplateMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateSmsTemplateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsRestjson1_serializeOpUpdateSmsTemplate{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsRestjson1_deserializeOpUpdateSmsTemplate{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opUpdateSmsTemplate(options.Region)); err != nil {
		return err
	}
