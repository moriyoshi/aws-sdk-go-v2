...
type CreateServerInput struct {
	...
	//
	//     * CHEF_AUTOMATE_PIVOTAL_KEY: A base64-encoded RSA
	// public key. The corresponding private key is required to access the Chef API.
	// When no CHEF_AUTOMATE_PIVOTAL_KEY is set, a private key is generated and
	// returned in the response.
	//
	//     * CHEF_AUTOMATE_ADMIN_PASSWORD: The password for
	// the administrative user in the Chef Automate web-based dashboard. The password
	...
	// and one special character. When no CHEF_AUTOMATE_ADMIN_PASSWORD is set, one is
	// generated and returned in the response.
	//
	// Attributes accepted in a Puppet
	// createServer request:
	//
	//     * PUPPET_ADMIN_PASSWORD: To work with the Puppet
	// Enterprise console, a password must use ASCII characters.
	//
	//     *
	// PUPPET_R10K_REMOTE: The r10k remote is the URL of your control repository (for
	// example, ssh://git@your.git-repo.com:user/control-repo.git). Specifying an r10k
	// remote opens TCP port 8170.
	//
	//     * PUPPET_R10K_PRIVATE_KEY: If you are using a
	// private Git repository, add PUPPET_R10K_PRIVATE_KEY to specify a PEM-encoded
	// private SSH key.
...
func addOperationCreateServerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsAwsjson11_serializeOpCreateServer{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsAwsjson11_deserializeOpCreateServer{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opCreateServer(options.Region)); err != nil {
		return err
	}
