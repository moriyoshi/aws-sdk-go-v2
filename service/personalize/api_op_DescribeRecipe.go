...
// create a solution with the CreateSolution API. CreateSolution trains a model by
// using the algorithm in the specified recipe and a training dataset. The
...
func addOperationDescribeRecipeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsAwsjson11_serializeOpDescribeRecipe{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsAwsjson11_deserializeOpDescribeRecipe{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opDescribeRecipe(options.Region)); err != nil {
		return err
	}
