...
func (c *Client) StartRxNormInferenceJob(ctx context.Context, params *StartRxNormInferenceJobInput, optFns ...func(*Options)) (*StartRxNormInferenceJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartRxNormInferenceJob", params, optFns, addOperationStartRxNormInferenceJobMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationStartRxNormInferenceJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsAwsjson11_serializeOpStartRxNormInferenceJob{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsAwsjson11_deserializeOpStartRxNormInferenceJob{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opStartRxNormInferenceJob(options.Region)); err != nil {
		return err
	}
...
func addIdempotencyToken_opStartRxNormInferenceJobMiddleware(stack *middleware.Stack, cfg Options) error {
	return stack.Initialize.Add(middleware.Before, &idempotencyToken_initializeOpStartRxNormInferenceJob{tokenProvider: cfg.IdempotencyTokenProvider})
}
