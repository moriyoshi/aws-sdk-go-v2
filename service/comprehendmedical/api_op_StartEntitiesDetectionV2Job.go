...
func addOperationStartEntitiesDetectionV2JobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsAwsjson11_serializeOpStartEntitiesDetectionV2Job{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsAwsjson11_deserializeOpStartEntitiesDetectionV2Job{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opStartEntitiesDetectionV2Job(options.Region)); err != nil {
		return err
	}
...
func addIdempotencyToken_opStartEntitiesDetectionV2JobMiddleware(stack *middleware.Stack, cfg Options) error {
	return stack.Initialize.Add(middleware.Before, &idempotencyToken_initializeOpStartEntitiesDetectionV2Job{tokenProvider: cfg.IdempotencyTokenProvider})
}
