...
func (c *Client) ModifyOptionGroup(ctx context.Context, params *ModifyOptionGroupInput, optFns ...func(*Options)) (*ModifyOptionGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyOptionGroup", params, optFns, addOperationModifyOptionGroupMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyOptionGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsAwsquery_serializeOpModifyOptionGroup{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsAwsquery_deserializeOpModifyOptionGroup{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opModifyOptionGroup(options.Region)); err != nil {
		return err
	}
