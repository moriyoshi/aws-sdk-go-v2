...
// a SourceIdentifier, you receive notice of the events for that source type for
...
type CreateEventSubscriptionInput struct {
	...
	//
	//     * If
	// the source type is a DB instance, a DBInstanceIdentifier value must be
	// supplied.
	//
...
func addOperationCreateEventSubscriptionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsAwsquery_serializeOpCreateEventSubscription{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsAwsquery_deserializeOpCreateEventSubscription{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opCreateEventSubscription(options.Region)); err != nil {
		return err
	}
