...
func (c *Client) DescribeDBProxyTargets(ctx context.Context, params *DescribeDBProxyTargetsInput, optFns ...func(*Options)) (*DescribeDBProxyTargetsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeDBProxyTargets", params, optFns, addOperationDescribeDBProxyTargetsMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeDBProxyTargetsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsAwsquery_serializeOpDescribeDBProxyTargets{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsAwsquery_deserializeOpDescribeDBProxyTargets{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opDescribeDBProxyTargets(options.Region)); err != nil {
		return err
	}
