...
func (c *Client) ReimportApi(ctx context.Context, params *ReimportApiInput, optFns ...func(*Options)) (*ReimportApiOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ReimportApi", params, optFns, addOperationReimportApiMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationReimportApiMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsRestjson1_serializeOpReimportApi{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsRestjson1_deserializeOpReimportApi{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opReimportApi(options.Region)); err != nil {
		return err
	}
