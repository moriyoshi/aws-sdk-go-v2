...
func (c *Client) CreateApi(ctx context.Context, params *CreateApiInput, optFns ...func(*Options)) (*CreateApiOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateApi", params, optFns, addOperationCreateApiMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateApiMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsRestjson1_serializeOpCreateApi{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsRestjson1_deserializeOpCreateApi{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opCreateApi(options.Region)); err != nil {
		return err
	}
