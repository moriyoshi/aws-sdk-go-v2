...
func (c *Client) GetRoute(ctx context.Context, params *GetRouteInput, optFns ...func(*Options)) (*GetRouteOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetRoute", params, optFns, addOperationGetRouteMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationGetRouteMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsRestjson1_serializeOpGetRoute{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsRestjson1_deserializeOpGetRoute{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opGetRoute(options.Region)); err != nil {
		return err
	}
