...
func (c *Client) DecreaseReplicaCount(ctx context.Context, params *DecreaseReplicaCountInput, optFns ...func(*Options)) (*DecreaseReplicaCountOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DecreaseReplicaCount", params, optFns, addOperationDecreaseReplicaCountMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationDecreaseReplicaCountMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsAwsquery_serializeOpDecreaseReplicaCount{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsAwsquery_deserializeOpDecreaseReplicaCount{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opDecreaseReplicaCount(options.Region)); err != nil {
		return err
	}
