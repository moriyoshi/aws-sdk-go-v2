...
func (c *Client) DescribeCacheParameters(ctx context.Context, params *DescribeCacheParametersInput, optFns ...func(*Options)) (*DescribeCacheParametersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeCacheParameters", params, optFns, addOperationDescribeCacheParametersMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeCacheParametersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsAwsquery_serializeOpDescribeCacheParameters{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsAwsquery_deserializeOpDescribeCacheParameters{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opDescribeCacheParameters(options.Region)); err != nil {
		return err
	}
