...
func (c *Client) CreateJobTemplate(ctx context.Context, params *CreateJobTemplateInput, optFns ...func(*Options)) (*CreateJobTemplateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateJobTemplate", params, optFns, addOperationCreateJobTemplateMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateJobTemplateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsRestjson1_serializeOpCreateJobTemplate{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsRestjson1_deserializeOpCreateJobTemplate{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opCreateJobTemplate(options.Region)); err != nil {
		return err
	}
