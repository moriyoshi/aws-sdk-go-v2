...
func (c *Client) DeleteIdentities(ctx context.Context, params *DeleteIdentitiesInput, optFns ...func(*Options)) (*DeleteIdentitiesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteIdentities", params, optFns, addOperationDeleteIdentitiesMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteIdentitiesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsAwsjson11_serializeOpDeleteIdentities{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsAwsjson11_deserializeOpDeleteIdentities{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opDeleteIdentities(options.Region)); err != nil {
		return err
	}
