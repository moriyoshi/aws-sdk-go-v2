...
func addOperationEnableMacieMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsRestjson1_serializeOpEnableMacie{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsRestjson1_deserializeOpEnableMacie{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opEnableMacie(options.Region)); err != nil {
		return err
	}
...
func addIdempotencyToken_opEnableMacieMiddleware(stack *middleware.Stack, cfg Options) error {
	return stack.Initialize.Add(middleware.Before, &idempotencyToken_initializeOpEnableMacie{tokenProvider: cfg.IdempotencyTokenProvider})
}
