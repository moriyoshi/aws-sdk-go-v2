...
func addOperationEnableOrganizationAdminAccountMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsRestjson1_serializeOpEnableOrganizationAdminAccount{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsRestjson1_deserializeOpEnableOrganizationAdminAccount{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opEnableOrganizationAdminAccount(options.Region)); err != nil {
		return err
	}
...
func addIdempotencyToken_opEnableOrganizationAdminAccountMiddleware(stack *middleware.Stack, cfg Options) error {
	return stack.Initialize.Add(middleware.Before, &idempotencyToken_initializeOpEnableOrganizationAdminAccount{tokenProvider: cfg.IdempotencyTokenProvider})
}
