...
func (c *Client) StartWorkflowExecution(ctx context.Context, params *StartWorkflowExecutionInput, optFns ...func(*Options)) (*StartWorkflowExecutionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartWorkflowExecution", params, optFns, addOperationStartWorkflowExecutionMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationStartWorkflowExecutionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsAwsjson10_serializeOpStartWorkflowExecution{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsAwsjson10_deserializeOpStartWorkflowExecution{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opStartWorkflowExecution(options.Region)); err != nil {
		return err
	}
