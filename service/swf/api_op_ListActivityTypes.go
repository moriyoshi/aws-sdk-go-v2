...
func (c *Client) ListActivityTypes(ctx context.Context, params *ListActivityTypesInput, optFns ...func(*Options)) (*ListActivityTypesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListActivityTypes", params, optFns, addOperationListActivityTypesMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationListActivityTypesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsAwsjson10_serializeOpListActivityTypes{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsAwsjson10_deserializeOpListActivityTypes{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opListActivityTypes(options.Region)); err != nil {
		return err
	}
