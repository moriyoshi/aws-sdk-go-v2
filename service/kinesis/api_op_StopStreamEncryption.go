...
func (c *Client) StopStreamEncryption(ctx context.Context, params *StopStreamEncryptionInput, optFns ...func(*Options)) (*StopStreamEncryptionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StopStreamEncryption", params, optFns, addOperationStopStreamEncryptionMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationStopStreamEncryptionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsAwsjson11_serializeOpStopStreamEncryption{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsAwsjson11_deserializeOpStopStreamEncryption{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opStopStreamEncryption(options.Region)); err != nil {
		return err
	}
