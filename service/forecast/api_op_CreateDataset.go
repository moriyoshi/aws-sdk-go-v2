...
// For more information, see howitworks-datasets-groups. To get a list of all your
// datasets, use the ListDatasets operation. For example Forecast datasets, see the
// Amazon Forecast Sample GitHub repository
...
func addOperationCreateDatasetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsAwsjson11_serializeOpCreateDataset{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsAwsjson11_deserializeOpCreateDataset{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opCreateDataset(options.Region)); err != nil {
		return err
	}
