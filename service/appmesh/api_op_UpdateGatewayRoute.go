...
func (c *Client) UpdateGatewayRoute(ctx context.Context, params *UpdateGatewayRouteInput, optFns ...func(*Options)) (*UpdateGatewayRouteOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateGatewayRoute", params, optFns, addOperationUpdateGatewayRouteMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateGatewayRouteMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsRestjson1_serializeOpUpdateGatewayRoute{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsRestjson1_deserializeOpUpdateGatewayRoute{})
	if err != nil {
		return err
	}
