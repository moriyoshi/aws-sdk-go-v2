...
func addOperationCreateWorldGenerationJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsRestjson1_serializeOpCreateWorldGenerationJob{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsRestjson1_deserializeOpCreateWorldGenerationJob{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opCreateWorldGenerationJob(options.Region)); err != nil {
		return err
	}
...
func addIdempotencyToken_opCreateWorldGenerationJobMiddleware(stack *middleware.Stack, cfg Options) error {
	return stack.Initialize.Add(middleware.Before, &idempotencyToken_initializeOpCreateWorldGenerationJob{tokenProvider: cfg.IdempotencyTokenProvider})
}
