...
func (c *Client) CreateRobotApplication(ctx context.Context, params *CreateRobotApplicationInput, optFns ...func(*Options)) (*CreateRobotApplicationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateRobotApplication", params, optFns, addOperationCreateRobotApplicationMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateRobotApplicationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsRestjson1_serializeOpCreateRobotApplication{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsRestjson1_deserializeOpCreateRobotApplication{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opCreateRobotApplication(options.Region)); err != nil {
		return err
	}
