...
func (c *Client) GetQueueAttributes(ctx context.Context, params *GetQueueAttributesInput, optFns ...func(*Options)) (*GetQueueAttributesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetQueueAttributes", params, optFns, addOperationGetQueueAttributesMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationGetQueueAttributesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsAwsquery_serializeOpGetQueueAttributes{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsAwsquery_deserializeOpGetQueueAttributes{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opGetQueueAttributes(options.Region)); err != nil {
		return err
	}
