...
func (c *Client) GetLoadBalancerMetricData(ctx context.Context, params *GetLoadBalancerMetricDataInput, optFns ...func(*Options)) (*GetLoadBalancerMetricDataOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetLoadBalancerMetricData", params, optFns, addOperationGetLoadBalancerMetricDataMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationGetLoadBalancerMetricDataMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsAwsjson11_serializeOpGetLoadBalancerMetricData{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsAwsjson11_deserializeOpGetLoadBalancerMetricData{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opGetLoadBalancerMetricData(options.Region)); err != nil {
		return err
	}
