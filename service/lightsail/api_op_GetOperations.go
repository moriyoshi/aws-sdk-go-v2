...
func (c *Client) GetOperations(ctx context.Context, params *GetOperationsInput, optFns ...func(*Options)) (*GetOperationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetOperations", params, optFns, addOperationGetOperationsMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationGetOperationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsAwsjson11_serializeOpGetOperations{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsAwsjson11_deserializeOpGetOperations{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opGetOperations(options.Region)); err != nil {
		return err
	}
