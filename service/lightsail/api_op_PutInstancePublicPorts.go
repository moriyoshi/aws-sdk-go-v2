...
func (c *Client) PutInstancePublicPorts(ctx context.Context, params *PutInstancePublicPortsInput, optFns ...func(*Options)) (*PutInstancePublicPortsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutInstancePublicPorts", params, optFns, addOperationPutInstancePublicPortsMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationPutInstancePublicPortsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsAwsjson11_serializeOpPutInstancePublicPorts{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsAwsjson11_deserializeOpPutInstancePublicPorts{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opPutInstancePublicPorts(options.Region)); err != nil {
		return err
	}
