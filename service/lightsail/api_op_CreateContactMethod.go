...
func (c *Client) CreateContactMethod(ctx context.Context, params *CreateContactMethodInput, optFns ...func(*Options)) (*CreateContactMethodOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateContactMethod", params, optFns, addOperationCreateContactMethodMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateContactMethodMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsAwsjson11_serializeOpCreateContactMethod{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsAwsjson11_deserializeOpCreateContactMethod{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opCreateContactMethod(options.Region)); err != nil {
		return err
	}
