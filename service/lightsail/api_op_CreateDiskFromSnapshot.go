...
func (c *Client) CreateDiskFromSnapshot(ctx context.Context, params *CreateDiskFromSnapshotInput, optFns ...func(*Options)) (*CreateDiskFromSnapshotOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateDiskFromSnapshot", params, optFns, addOperationCreateDiskFromSnapshotMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateDiskFromSnapshotMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsAwsjson11_serializeOpCreateDiskFromSnapshot{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsAwsjson11_deserializeOpCreateDiskFromSnapshot{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opCreateDiskFromSnapshot(options.Region)); err != nil {
		return err
	}
