...
func (c *Client) GetJobOutput(ctx context.Context, params *GetJobOutputInput, optFns ...func(*Options)) (*GetJobOutputOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetJobOutput", params, optFns, addOperationGetJobOutputMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationGetJobOutputMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsRestjson1_serializeOpGetJobOutput{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsRestjson1_deserializeOpGetJobOutput{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opGetJobOutput(options.Region)); err != nil {
		return err
	}
