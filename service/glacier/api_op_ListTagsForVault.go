...
func (c *Client) ListTagsForVault(ctx context.Context, params *ListTagsForVaultInput, optFns ...func(*Options)) (*ListTagsForVaultOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListTagsForVault", params, optFns, addOperationListTagsForVaultMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationListTagsForVaultMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsRestjson1_serializeOpListTagsForVault{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsRestjson1_deserializeOpListTagsForVault{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opListTagsForVault(options.Region)); err != nil {
		return err
	}
