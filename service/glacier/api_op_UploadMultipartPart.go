...
//
//     * SHA256 tree hash does not matchTo
// ensure that part data is not corrupted in transmission, you compute a SHA256
// tree hash of the part and include it in your request. Upon receiving the part
// data, Amazon S3 Glacier also computes a SHA256 tree hash. If these hash values
// don't match, the operation fails. For information about computing a SHA256 tree
...
func addOperationUploadMultipartPartMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsRestjson1_serializeOpUploadMultipartPart{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsRestjson1_deserializeOpUploadMultipartPart{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opUploadMultipartPart(options.Region)); err != nil {
		return err
	}
