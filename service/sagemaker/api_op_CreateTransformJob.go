...
func (c *Client) CreateTransformJob(ctx context.Context, params *CreateTransformJobInput, optFns ...func(*Options)) (*CreateTransformJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateTransformJob", params, optFns, addOperationCreateTransformJobMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateTransformJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsAwsjson11_serializeOpCreateTransformJob{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsAwsjson11_deserializeOpCreateTransformJob{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opCreateTransformJob(options.Region)); err != nil {
		return err
	}
