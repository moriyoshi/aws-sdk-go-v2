...
//
//     * TextTransformation: Which text transformation,
// if any, to perform on the web request before inspecting the request for
// cross-site scripting attacks. You can only specify a single type of
// TextTransformation.
//
...
func addOperationUpdateXssMatchSetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsAwsjson11_serializeOpUpdateXssMatchSet{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsAwsjson11_deserializeOpUpdateXssMatchSet{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opUpdateXssMatchSet(options.Region)); err != nil {
		return err
	}
