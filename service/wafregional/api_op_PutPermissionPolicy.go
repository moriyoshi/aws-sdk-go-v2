...
func (c *Client) PutPermissionPolicy(ctx context.Context, params *PutPermissionPolicyInput, optFns ...func(*Options)) (*PutPermissionPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutPermissionPolicy", params, optFns, addOperationPutPermissionPolicyMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationPutPermissionPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsAwsjson11_serializeOpPutPermissionPolicy{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsAwsjson11_deserializeOpPutPermissionPolicy{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opPutPermissionPolicy(options.Region)); err != nil {
		return err
	}
