...
//
//     * Temporary credentials - specify
// the cluster identifier, the database name, and the database user name.
// Permission to call the redshift:GetClusterCredentials operation is required to
// use this method.
...
func addOperationListTablesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsAwsjson11_serializeOpListTables{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsAwsjson11_deserializeOpListTables{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opListTables(options.Region)); err != nil {
		return err
	}
