...
type DescribeStatementOutput struct {
	...
	//
	//     * ALL - A
	// status value that includes all query statuses. This value can be used to filter
	// results.
	//
	//     * FAILED - The query run failed.
	//
	//     * FINISHED - The query has
	// finished running.
	//
	...
	//
	//     * SUBMITTED - The query was submitted,
...
func addOperationDescribeStatementMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsAwsjson11_serializeOpDescribeStatement{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsAwsjson11_deserializeOpDescribeStatement{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opDescribeStatement(options.Region)); err != nil {
		return err
	}
