...
func (c *Client) GetObjectInformation(ctx context.Context, params *GetObjectInformationInput, optFns ...func(*Options)) (*GetObjectInformationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetObjectInformation", params, optFns, addOperationGetObjectInformationMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationGetObjectInformationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsRestjson1_serializeOpGetObjectInformation{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsRestjson1_deserializeOpGetObjectInformation{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opGetObjectInformation(options.Region)); err != nil {
		return err
	}
