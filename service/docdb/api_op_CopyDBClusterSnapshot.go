...
type CopyDBClusterSnapshotInput struct {
	...
	// available state.
	//
	//     * If the source snapshot is in the same AWS Region as the
	// copy, specify a valid snapshot identifier.
	//
	//     * If the source snapshot is in a
	// different AWS Region than the copy, specify a valid cluster snapshot
	// ARN.
	//
...
func addOperationCopyDBClusterSnapshotMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsAwsquery_serializeOpCopyDBClusterSnapshot{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsAwsquery_deserializeOpCopyDBClusterSnapshot{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opCopyDBClusterSnapshot(options.Region)); err != nil {
		return err
	}
