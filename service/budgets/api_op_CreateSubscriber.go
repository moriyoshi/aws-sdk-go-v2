...
func (c *Client) CreateSubscriber(ctx context.Context, params *CreateSubscriberInput, optFns ...func(*Options)) (*CreateSubscriberOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateSubscriber", params, optFns, addOperationCreateSubscriberMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateSubscriberMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsAwsjson11_serializeOpCreateSubscriber{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsAwsjson11_deserializeOpCreateSubscriber{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opCreateSubscriber(options.Region)); err != nil {
		return err
	}
