...
func (c *Client) ExecuteBudgetAction(ctx context.Context, params *ExecuteBudgetActionInput, optFns ...func(*Options)) (*ExecuteBudgetActionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ExecuteBudgetAction", params, optFns, addOperationExecuteBudgetActionMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationExecuteBudgetActionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsAwsjson11_serializeOpExecuteBudgetAction{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsAwsjson11_deserializeOpExecuteBudgetAction{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opExecuteBudgetAction(options.Region)); err != nil {
		return err
	}
