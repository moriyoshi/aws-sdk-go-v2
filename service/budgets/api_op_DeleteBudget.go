...
func (c *Client) DeleteBudget(ctx context.Context, params *DeleteBudgetInput, optFns ...func(*Options)) (*DeleteBudgetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteBudget", params, optFns, addOperationDeleteBudgetMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteBudgetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsAwsjson11_serializeOpDeleteBudget{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsAwsjson11_deserializeOpDeleteBudget{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opDeleteBudget(options.Region)); err != nil {
		return err
	}
