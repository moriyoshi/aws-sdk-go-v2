...
func (c *Client) CreateBudget(ctx context.Context, params *CreateBudgetInput, optFns ...func(*Options)) (*CreateBudgetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateBudget", params, optFns, addOperationCreateBudgetMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateBudgetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsAwsjson11_serializeOpCreateBudget{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsAwsjson11_deserializeOpCreateBudget{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opCreateBudget(options.Region)); err != nil {
		return err
	}
