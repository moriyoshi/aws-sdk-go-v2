...
func addOperationCreatePresignedPortalUrlMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsRestjson1_serializeOpCreatePresignedPortalUrl{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsRestjson1_deserializeOpCreatePresignedPortalUrl{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opCreatePresignedPortalUrl(options.Region)); err != nil {
		return err
	}
...
func addEndpointPrefix_opCreatePresignedPortalUrlMiddleware(stack *middleware.Stack) error {
	return stack.Serialize.Insert("OperationSerializer", middleware.Before, &endpointPrefix_opCreatePresignedPortalUrlMiddleware{})
}
