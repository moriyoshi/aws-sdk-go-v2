...
func addOperationPostCommentReplyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsAwsjson11_serializeOpPostCommentReply{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsAwsjson11_deserializeOpPostCommentReply{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opPostCommentReply(options.Region)); err != nil {
		return err
	}
...
func addIdempotencyToken_opPostCommentReplyMiddleware(stack *middleware.Stack, cfg Options) error {
	return stack.Initialize.Add(middleware.Before, &idempotencyToken_initializeOpPostCommentReply{tokenProvider: cfg.IdempotencyTokenProvider})
}
