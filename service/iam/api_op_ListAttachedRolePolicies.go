...
func (c *Client) ListAttachedRolePolicies(ctx context.Context, params *ListAttachedRolePoliciesInput, optFns ...func(*Options)) (*ListAttachedRolePoliciesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListAttachedRolePolicies", params, optFns, addOperationListAttachedRolePoliciesMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationListAttachedRolePoliciesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsAwsquery_serializeOpListAttachedRolePolicies{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsAwsquery_deserializeOpListAttachedRolePolicies{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opListAttachedRolePolicies(options.Region)); err != nil {
		return err
	}
