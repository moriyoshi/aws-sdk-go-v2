...
func (c *Client) ListServerCertificates(ctx context.Context, params *ListServerCertificatesInput, optFns ...func(*Options)) (*ListServerCertificatesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListServerCertificates", params, optFns, addOperationListServerCertificatesMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationListServerCertificatesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsAwsquery_serializeOpListServerCertificates{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsAwsquery_deserializeOpListServerCertificates{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opListServerCertificates(options.Region)); err != nil {
		return err
	}
