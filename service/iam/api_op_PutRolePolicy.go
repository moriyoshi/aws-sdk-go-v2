...
func (c *Client) PutRolePolicy(ctx context.Context, params *PutRolePolicyInput, optFns ...func(*Options)) (*PutRolePolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutRolePolicy", params, optFns, addOperationPutRolePolicyMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationPutRolePolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsAwsquery_serializeOpPutRolePolicy{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsAwsquery_deserializeOpPutRolePolicy{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opPutRolePolicy(options.Region)); err != nil {
		return err
	}
