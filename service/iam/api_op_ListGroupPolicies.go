...
func (c *Client) ListGroupPolicies(ctx context.Context, params *ListGroupPoliciesInput, optFns ...func(*Options)) (*ListGroupPoliciesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListGroupPolicies", params, optFns, addOperationListGroupPoliciesMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationListGroupPoliciesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsAwsquery_serializeOpListGroupPolicies{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsAwsquery_deserializeOpListGroupPolicies{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opListGroupPolicies(options.Region)); err != nil {
		return err
	}
