...
func (c *Client) PutRolePermissionsBoundary(ctx context.Context, params *PutRolePermissionsBoundaryInput, optFns ...func(*Options)) (*PutRolePermissionsBoundaryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutRolePermissionsBoundary", params, optFns, addOperationPutRolePermissionsBoundaryMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationPutRolePermissionsBoundaryMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsAwsquery_serializeOpPutRolePermissionsBoundary{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsAwsquery_deserializeOpPutRolePermissionsBoundary{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opPutRolePermissionsBoundary(options.Region)); err != nil {
		return err
	}
