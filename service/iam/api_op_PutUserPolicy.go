...
func (c *Client) PutUserPolicy(ctx context.Context, params *PutUserPolicyInput, optFns ...func(*Options)) (*PutUserPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutUserPolicy", params, optFns, addOperationPutUserPolicyMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationPutUserPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsAwsquery_serializeOpPutUserPolicy{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsAwsquery_deserializeOpPutUserPolicy{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opPutUserPolicy(options.Region)); err != nil {
		return err
	}
