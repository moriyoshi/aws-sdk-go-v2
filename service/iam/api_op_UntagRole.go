...
func (c *Client) UntagRole(ctx context.Context, params *UntagRoleInput, optFns ...func(*Options)) (*UntagRoleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UntagRole", params, optFns, addOperationUntagRoleMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationUntagRoleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsAwsquery_serializeOpUntagRole{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsAwsquery_deserializeOpUntagRole{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opUntagRole(options.Region)); err != nil {
		return err
	}
