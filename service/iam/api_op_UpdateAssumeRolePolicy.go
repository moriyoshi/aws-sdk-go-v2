...
type UpdateAssumeRolePolicyInput struct {
	...
	//
	//     * The printable characters in the Basic
	// Latin and Latin-1 Supplement character set (through \u00FF)
	//
	//     * The special
...
func addOperationUpdateAssumeRolePolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsAwsquery_serializeOpUpdateAssumeRolePolicy{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsAwsquery_deserializeOpUpdateAssumeRolePolicy{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opUpdateAssumeRolePolicy(options.Region)); err != nil {
		return err
	}
