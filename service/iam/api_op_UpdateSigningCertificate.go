...
func (c *Client) UpdateSigningCertificate(ctx context.Context, params *UpdateSigningCertificateInput, optFns ...func(*Options)) (*UpdateSigningCertificateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateSigningCertificate", params, optFns, addOperationUpdateSigningCertificateMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateSigningCertificateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsAwsquery_serializeOpUpdateSigningCertificate{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsAwsquery_deserializeOpUpdateSigningCertificate{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opUpdateSigningCertificate(options.Region)); err != nil {
		return err
	}
