...
func validateOpCreateMaintenanceWindowInput(v *CreateMaintenanceWindowInput) error {
	...
	if v.AllowUnassociatedTargets == nil {
		invalidParams.Add(smithy.NewErrParamRequired("AllowUnassociatedTargets"))
	}
	if v.Duration == nil {
	...
	if v.Cutoff == nil {
		invalidParams.Add(smithy.NewErrParamRequired("Cutoff"))
	}
	if invalidParams.Len() > 0 {
		return invalidParams
	} else {
...
func validateOpRegisterTaskWithMaintenanceWindowInput(v *RegisterTaskWithMaintenanceWindowInput) error {
	...
	if v.MaxErrors == nil {
		invalidParams.Add(smithy.NewErrParamRequired("MaxErrors"))
	}
