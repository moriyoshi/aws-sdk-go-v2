...
func (c *Client) GetMaintenanceWindow(ctx context.Context, params *GetMaintenanceWindowInput, optFns ...func(*Options)) (*GetMaintenanceWindowOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetMaintenanceWindow", params, optFns, addOperationGetMaintenanceWindowMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationGetMaintenanceWindowMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsAwsjson11_serializeOpGetMaintenanceWindow{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsAwsjson11_deserializeOpGetMaintenanceWindow{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opGetMaintenanceWindow(options.Region)); err != nil {
		return err
	}
