...
func (c *Client) GetPatchBaseline(ctx context.Context, params *GetPatchBaselineInput, optFns ...func(*Options)) (*GetPatchBaselineOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetPatchBaseline", params, optFns, addOperationGetPatchBaselineMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationGetPatchBaselineMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsAwsjson11_serializeOpGetPatchBaseline{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsAwsjson11_deserializeOpGetPatchBaseline{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opGetPatchBaseline(options.Region)); err != nil {
		return err
	}
