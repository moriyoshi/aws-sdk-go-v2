...
//
//     * The media
// must contain h.264 or h.265 encoded video and, optionally, AAC or G.711 encoded
...
// greater than 0.
//
//     * The video track of each fragment must contain codec
// private data in the Advanced Video Coding (AVC) for H.264 format and HEVC for
// H.265 format. For more information, see MPEG-4 specification ISO/IEC 14496-15
...
func addOperationGetClipMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsRestjson1_serializeOpGetClip{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsRestjson1_deserializeOpGetClip{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opGetClip(options.Region)); err != nil {
		return err
	}
