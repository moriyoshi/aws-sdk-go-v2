...
func (c *Client) PutMethodResponse(ctx context.Context, params *PutMethodResponseInput, optFns ...func(*Options)) (*PutMethodResponseOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutMethodResponse", params, optFns, addOperationPutMethodResponseMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationPutMethodResponseMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsRestjson1_serializeOpPutMethodResponse{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsRestjson1_deserializeOpPutMethodResponse{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opPutMethodResponse(options.Region)); err != nil {
		return err
	}
