...
func (c *Client) GetAuthorizer(ctx context.Context, params *GetAuthorizerInput, optFns ...func(*Options)) (*GetAuthorizerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetAuthorizer", params, optFns, addOperationGetAuthorizerMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationGetAuthorizerMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsRestjson1_serializeOpGetAuthorizer{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsRestjson1_deserializeOpGetAuthorizer{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opGetAuthorizer(options.Region)); err != nil {
		return err
	}
