...
func (c *Client) GetSdk(ctx context.Context, params *GetSdkInput, optFns ...func(*Options)) (*GetSdkOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetSdk", params, optFns, addOperationGetSdkMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationGetSdkMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsRestjson1_serializeOpGetSdk{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsRestjson1_deserializeOpGetSdk{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opGetSdk(options.Region)); err != nil {
		return err
	}
