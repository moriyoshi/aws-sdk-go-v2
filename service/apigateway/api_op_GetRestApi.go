...
func (c *Client) GetRestApi(ctx context.Context, params *GetRestApiInput, optFns ...func(*Options)) (*GetRestApiOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetRestApi", params, optFns, addOperationGetRestApiMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationGetRestApiMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsRestjson1_serializeOpGetRestApi{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsRestjson1_deserializeOpGetRestApi{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opGetRestApi(options.Region)); err != nil {
		return err
	}
