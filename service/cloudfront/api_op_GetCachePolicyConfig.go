...
func (c *Client) GetCachePolicyConfig(ctx context.Context, params *GetCachePolicyConfigInput, optFns ...func(*Options)) (*GetCachePolicyConfigOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetCachePolicyConfig", params, optFns, addOperationGetCachePolicyConfigMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationGetCachePolicyConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsRestxml_serializeOpGetCachePolicyConfig{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsRestxml_deserializeOpGetCachePolicyConfig{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opGetCachePolicyConfig(options.Region)); err != nil {
		return err
	}
