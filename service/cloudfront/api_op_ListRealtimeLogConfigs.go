...
func (c *Client) ListRealtimeLogConfigs(ctx context.Context, params *ListRealtimeLogConfigsInput, optFns ...func(*Options)) (*ListRealtimeLogConfigsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListRealtimeLogConfigs", params, optFns, addOperationListRealtimeLogConfigsMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationListRealtimeLogConfigsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsRestxml_serializeOpListRealtimeLogConfigs{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsRestxml_deserializeOpListRealtimeLogConfigs{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opListRealtimeLogConfigs(options.Region)); err != nil {
		return err
	}
