...
// Sets or updates the AWS IoT Analytics logging options. Note that if you update
// the value of any loggingOptions field, it takes up to one minute for the change
// to take effect. Also, if you change the policy attached to the role you
...
func addOperationPutLoggingOptionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsRestjson1_serializeOpPutLoggingOptions{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsRestjson1_deserializeOpPutLoggingOptions{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opPutLoggingOptions(options.Region)); err != nil {
		return err
	}
