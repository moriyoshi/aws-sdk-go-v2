...
func (c *Client) CreateCustomKeyStore(ctx context.Context, params *CreateCustomKeyStoreInput, optFns ...func(*Options)) (*CreateCustomKeyStoreOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateCustomKeyStore", params, optFns, addOperationCreateCustomKeyStoreMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateCustomKeyStoreMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsAwsjson11_serializeOpCreateCustomKeyStore{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsAwsjson11_deserializeOpCreateCustomKeyStore{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opCreateCustomKeyStore(options.Region)); err != nil {
		return err
	}
