...
func (c *Client) SetSMSAttributes(ctx context.Context, params *SetSMSAttributesInput, optFns ...func(*Options)) (*SetSMSAttributesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SetSMSAttributes", params, optFns, addOperationSetSMSAttributesMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationSetSMSAttributesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsAwsquery_serializeOpSetSMSAttributes{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsAwsquery_deserializeOpSetSMSAttributes{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opSetSMSAttributes(options.Region)); err != nil {
		return err
	}
