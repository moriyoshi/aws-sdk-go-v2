...
func (c *Client) GetImportJob(ctx context.Context, params *GetImportJobInput, optFns ...func(*Options)) (*GetImportJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetImportJob", params, optFns, addOperationGetImportJobMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationGetImportJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsRestjson1_serializeOpGetImportJob{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsRestjson1_deserializeOpGetImportJob{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opGetImportJob(options.Region)); err != nil {
		return err
	}
