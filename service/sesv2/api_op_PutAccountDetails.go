...
func (c *Client) PutAccountDetails(ctx context.Context, params *PutAccountDetailsInput, optFns ...func(*Options)) (*PutAccountDetailsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutAccountDetails", params, optFns, addOperationPutAccountDetailsMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationPutAccountDetailsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsRestjson1_serializeOpPutAccountDetails{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsRestjson1_deserializeOpPutAccountDetails{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opPutAccountDetails(options.Region)); err != nil {
		return err
	}
