...
func (c *Client) Invoke(ctx context.Context, params *InvokeInput, optFns ...func(*Options)) (*InvokeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "Invoke", params, optFns, addOperationInvokeMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationInvokeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsRestjson1_serializeOpInvoke{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsRestjson1_deserializeOpInvoke{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opInvoke(options.Region)); err != nil {
		return err
	}
