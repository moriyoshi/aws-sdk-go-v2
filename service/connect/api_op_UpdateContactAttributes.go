...
// deleted. This operation is also available in the Amazon Connect Flow language.
...
// Important: You cannot use the operation to update attributes for contacts that
// occurred prior to the release of the API, September 12, 2018. You can update
// attributes only for contacts that started after the release of the API. If you
// attempt to update attributes for a contact that occurred prior to the release of
...
func addOperationUpdateContactAttributesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsRestjson1_serializeOpUpdateContactAttributes{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsRestjson1_deserializeOpUpdateContactAttributes{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opUpdateContactAttributes(options.Region)); err != nil {
		return err
	}
