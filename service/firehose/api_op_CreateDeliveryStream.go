...
//
//     * The
// compression formats SNAPPY or ZIP cannot be specified in
...
// you provide exclusively with Kinesis Data Firehose, and that the permissions for
...
func addOperationCreateDeliveryStreamMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsAwsjson11_serializeOpCreateDeliveryStream{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsAwsjson11_deserializeOpCreateDeliveryStream{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opCreateDeliveryStream(options.Region)); err != nil {
		return err
	}
