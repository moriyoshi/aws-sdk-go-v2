...
func (c *Client) DescribeEndpointTypes(ctx context.Context, params *DescribeEndpointTypesInput, optFns ...func(*Options)) (*DescribeEndpointTypesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeEndpointTypes", params, optFns, addOperationDescribeEndpointTypesMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeEndpointTypesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsAwsjson11_serializeOpDescribeEndpointTypes{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsAwsjson11_deserializeOpDescribeEndpointTypes{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opDescribeEndpointTypes(options.Region)); err != nil {
		return err
	}
