...
func addOperationRetrieveTimeSeriesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsRestjson1_serializeOpRetrieveTimeSeries{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsRestjson1_deserializeOpRetrieveTimeSeries{})
	if err != nil {
		return err
	}
