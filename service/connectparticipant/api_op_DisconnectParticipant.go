...
func addOperationDisconnectParticipantMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsRestjson1_serializeOpDisconnectParticipant{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsRestjson1_deserializeOpDisconnectParticipant{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opDisconnectParticipant(options.Region)); err != nil {
		return err
	}
...
func addIdempotencyToken_opDisconnectParticipantMiddleware(stack *middleware.Stack, cfg Options) error {
	return stack.Initialize.Add(middleware.Before, &idempotencyToken_initializeOpDisconnectParticipant{tokenProvider: cfg.IdempotencyTokenProvider})
}
