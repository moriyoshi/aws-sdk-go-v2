...
func (c *Client) DescribeStackResources(ctx context.Context, params *DescribeStackResourcesInput, optFns ...func(*Options)) (*DescribeStackResourcesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeStackResources", params, optFns, addOperationDescribeStackResourcesMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeStackResourcesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsAwsquery_serializeOpDescribeStackResources{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsAwsquery_deserializeOpDescribeStackResources{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opDescribeStackResources(options.Region)); err != nil {
		return err
	}
