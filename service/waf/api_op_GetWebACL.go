...
type GetWebACLOutput struct {
	...
	//
	//     * Rules: Contains an
	// array of ActivatedRule objects, which contain Action, Priority, and RuleId
	//
	//
...
func addOperationGetWebACLMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsAwsjson11_serializeOpGetWebACL{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsAwsjson11_deserializeOpGetWebACL{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opGetWebACL(options.Region)); err != nil {
		return err
	}
