...
// contain the value BadBot. Further, requests that match these two conditions much
// be received at a rate of more than 1,000 every five minutes. If the rate drops
...
func addOperationUpdateRateBasedRuleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsAwsjson11_serializeOpUpdateRateBasedRule{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsAwsjson11_deserializeOpUpdateRateBasedRule{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opUpdateRateBasedRule(options.Region)); err != nil {
		return err
	}
