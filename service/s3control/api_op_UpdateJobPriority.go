...
func addOperationUpdateJobPriorityMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsRestxml_serializeOpUpdateJobPriority{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsRestxml_deserializeOpUpdateJobPriority{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opUpdateJobPriority(options.Region)); err != nil {
		return err
	}
...
func addEndpointPrefix_opUpdateJobPriorityMiddleware(stack *middleware.Stack) error {
	return stack.Serialize.Insert("OperationSerializer", middleware.Before, &endpointPrefix_opUpdateJobPriorityMiddleware{})
}
