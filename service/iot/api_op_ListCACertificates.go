...
func (c *Client) ListCACertificates(ctx context.Context, params *ListCACertificatesInput, optFns ...func(*Options)) (*ListCACertificatesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListCACertificates", params, optFns, addOperationListCACertificatesMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationListCACertificatesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsRestjson1_serializeOpListCACertificates{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsRestjson1_deserializeOpListCACertificates{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opListCACertificates(options.Region)); err != nil {
		return err
	}
