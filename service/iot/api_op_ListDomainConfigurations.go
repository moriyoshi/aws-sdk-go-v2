...
func (c *Client) ListDomainConfigurations(ctx context.Context, params *ListDomainConfigurationsInput, optFns ...func(*Options)) (*ListDomainConfigurationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListDomainConfigurations", params, optFns, addOperationListDomainConfigurationsMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationListDomainConfigurationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsRestjson1_serializeOpListDomainConfigurations{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsRestjson1_deserializeOpListDomainConfigurations{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opListDomainConfigurations(options.Region)); err != nil {
		return err
	}
