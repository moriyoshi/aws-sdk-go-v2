...
func addOperationStartKeyPhrasesDetectionJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsAwsjson11_serializeOpStartKeyPhrasesDetectionJob{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsAwsjson11_deserializeOpStartKeyPhrasesDetectionJob{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opStartKeyPhrasesDetectionJob(options.Region)); err != nil {
		return err
	}
...
func addIdempotencyToken_opStartKeyPhrasesDetectionJobMiddleware(stack *middleware.Stack, cfg Options) error {
	return stack.Initialize.Add(middleware.Before, &idempotencyToken_initializeOpStartKeyPhrasesDetectionJob{tokenProvider: cfg.IdempotencyTokenProvider})
}
