...
type DescribeSpotInstanceRequestsInput struct {
	...
	// volume: gp2 for General Purpose SSD, io1 or io2 for Provisioned IOPS SSD, st1
...
func addOperationDescribeSpotInstanceRequestsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsEc2query_serializeOpDescribeSpotInstanceRequests{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsEc2query_deserializeOpDescribeSpotInstanceRequests{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opDescribeSpotInstanceRequests(options.Region)); err != nil {
		return err
	}
