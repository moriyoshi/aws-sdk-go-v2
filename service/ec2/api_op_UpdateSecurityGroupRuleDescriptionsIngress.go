...
func addOperationUpdateSecurityGroupRuleDescriptionsIngressMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsEc2query_serializeOpUpdateSecurityGroupRuleDescriptionsIngress{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsEc2query_deserializeOpUpdateSecurityGroupRuleDescriptionsIngress{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opUpdateSecurityGroupRuleDescriptionsIngress(options.Region)); err != nil {
		return err
	}
