...
type DescribeAddressesInput struct {
	...
	// with, if any.
	//
	//     * network-border-group - A unique set of Availability Zones,
	...
	//
	//     * network-interface-owner-id - The AWS
	// account ID of the owner.
	//
	//     * private-ip-address - [EC2-VPC] The private IP
	// address associated with the Elastic IP address.
	//
	//     * public-ip - The Elastic
	// IP address, or the carrier IP address.
	//
...
func addOperationDescribeAddressesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsEc2query_serializeOpDescribeAddresses{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsEc2query_deserializeOpDescribeAddresses{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opDescribeAddresses(options.Region)); err != nil {
		return err
	}
