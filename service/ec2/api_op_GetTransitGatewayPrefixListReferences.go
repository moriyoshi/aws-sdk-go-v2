...
type GetTransitGatewayPrefixListReferencesInput struct {
	...
	//
	//     * attachment.resource-type - The
	// type of resource for the attachment. Valid values are vpc | vpn |
	...
	//
	//     * prefix-list-owner-id - The
	// ID of the owner of the prefix list.
	//
	//     * state - The state of the prefix list
	// reference (pending | available | modifying | deleting).
...
func addOperationGetTransitGatewayPrefixListReferencesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsEc2query_serializeOpGetTransitGatewayPrefixListReferences{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsEc2query_deserializeOpGetTransitGatewayPrefixListReferences{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opGetTransitGatewayPrefixListReferences(options.Region)); err != nil {
		return err
	}
