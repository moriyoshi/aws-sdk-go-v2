...
func (c *Client) DescribeConfigurationOptions(ctx context.Context, params *DescribeConfigurationOptionsInput, optFns ...func(*Options)) (*DescribeConfigurationOptionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeConfigurationOptions", params, optFns, addOperationDescribeConfigurationOptionsMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeConfigurationOptionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsAwsquery_serializeOpDescribeConfigurationOptions{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsAwsquery_deserializeOpDescribeConfigurationOptions{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opDescribeConfigurationOptions(options.Region)); err != nil {
		return err
	}
