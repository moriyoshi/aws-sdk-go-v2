...
// available with a resolution of 1 hour. CloudWatch started retaining 5-minute and
// 1-hour metric data as of July 9, 2016. For information about metrics and
// dimensions supported by AWS services, see the Amazon CloudWatch Metrics and
...
func addOperationGetMetricStatisticsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsAwsquery_serializeOpGetMetricStatistics{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsAwsquery_deserializeOpGetMetricStatistics{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opGetMetricStatistics(options.Region)); err != nil {
		return err
	}
