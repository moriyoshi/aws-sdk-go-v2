...
func (c *Client) DeleteAlarms(ctx context.Context, params *DeleteAlarmsInput, optFns ...func(*Options)) (*DeleteAlarmsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteAlarms", params, optFns, addOperationDeleteAlarmsMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteAlarmsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsAwsquery_serializeOpDeleteAlarms{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsAwsquery_deserializeOpDeleteAlarms{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opDeleteAlarms(options.Region)); err != nil {
		return err
	}
