...
func (c *Client) CreatePortfolio(ctx context.Context, params *CreatePortfolioInput, optFns ...func(*Options)) (*CreatePortfolioOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreatePortfolio", params, optFns, addOperationCreatePortfolioMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationCreatePortfolioMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsAwsjson11_serializeOpCreatePortfolio{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsAwsjson11_deserializeOpCreatePortfolio{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opCreatePortfolio(options.Region)); err != nil {
		return err
	}
...
func addIdempotencyToken_opCreatePortfolioMiddleware(stack *middleware.Stack, cfg Options) error {
	return stack.Initialize.Add(middleware.Before, &idempotencyToken_initializeOpCreatePortfolio{tokenProvider: cfg.IdempotencyTokenProvider})
}
