...
type AcceptPortfolioShareInput struct {
	...
	// accept-portfolio-share --portfolio-id "port-2qwzkwxt3y5fk"
...
func addOperationAcceptPortfolioShareMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsAwsjson11_serializeOpAcceptPortfolioShare{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsAwsjson11_deserializeOpAcceptPortfolioShare{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opAcceptPortfolioShare(options.Region)); err != nil {
		return err
	}
