...
func addOperationPurchaseOfferingMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsRestjson1_serializeOpPurchaseOffering{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsRestjson1_deserializeOpPurchaseOffering{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opPurchaseOffering(options.Region)); err != nil {
		return err
	}
...
func addIdempotencyToken_opPurchaseOfferingMiddleware(stack *middleware.Stack, cfg Options) error {
	return stack.Initialize.Add(middleware.Before, &idempotencyToken_initializeOpPurchaseOffering{tokenProvider: cfg.IdempotencyTokenProvider})
}
