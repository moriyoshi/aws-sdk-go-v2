...
func (c *Client) GetJobManifest(ctx context.Context, params *GetJobManifestInput, optFns ...func(*Options)) (*GetJobManifestOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetJobManifest", params, optFns, addOperationGetJobManifestMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationGetJobManifestMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsAwsjson11_serializeOpGetJobManifest{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsAwsjson11_deserializeOpGetJobManifest{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opGetJobManifest(options.Region)); err != nil {
		return err
	}
