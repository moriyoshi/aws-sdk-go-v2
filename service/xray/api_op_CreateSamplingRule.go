...
type CreateSamplingRuleInput struct {
	...
	//
	//     * Maximum tag key
	// length: 128 Unicode characters
	//
	//     * Maximum tag value length: 256 Unicode
	// characters
	//
...
func addOperationCreateSamplingRuleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsRestjson1_serializeOpCreateSamplingRule{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsRestjson1_deserializeOpCreateSamplingRule{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opCreateSamplingRule(options.Region)); err != nil {
		return err
	}
