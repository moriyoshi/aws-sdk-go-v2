...
func (c *Client) GetMLTransform(ctx context.Context, params *GetMLTransformInput, optFns ...func(*Options)) (*GetMLTransformOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetMLTransform", params, optFns, addOperationGetMLTransformMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationGetMLTransformMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsAwsjson11_serializeOpGetMLTransform{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsAwsjson11_deserializeOpGetMLTransform{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opGetMLTransform(options.Region)); err != nil {
		return err
	}
