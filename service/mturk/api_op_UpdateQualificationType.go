...
func (c *Client) UpdateQualificationType(ctx context.Context, params *UpdateQualificationTypeInput, optFns ...func(*Options)) (*UpdateQualificationTypeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateQualificationType", params, optFns, addOperationUpdateQualificationTypeMiddlewares)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateQualificationTypeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsAwsjson11_serializeOpUpdateQualificationType{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsAwsjson11_deserializeOpUpdateQualificationType{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opUpdateQualificationType(options.Region)); err != nil {
		return err
	}
