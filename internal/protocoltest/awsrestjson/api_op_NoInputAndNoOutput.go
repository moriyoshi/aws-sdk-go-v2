...
func addOperationNoInputAndNoOutputMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsRestjson1_serializeOpNoInputAndNoOutput{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsRestjson1_deserializeOpNoInputAndNoOutput{})
	if err != nil {
		return err
	}
