...
func addOperationFlattenedXmlMapMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsRestxml_serializeOpFlattenedXmlMap{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsRestxml_deserializeOpFlattenedXmlMap{})
	if err != nil {
		return err
	}
