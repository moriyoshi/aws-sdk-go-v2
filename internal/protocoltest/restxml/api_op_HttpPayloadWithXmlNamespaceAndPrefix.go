...
func addOperationHttpPayloadWithXmlNamespaceAndPrefixMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(middleware.After, &awsRestxml_serializeOpHttpPayloadWithXmlNamespaceAndPrefix{})
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(middleware.After, &awsRestxml_deserializeOpHttpPayloadWithXmlNamespaceAndPrefix{})
	if err != nil {
		return err
	}
	...
	if err := stack.Initialize.Add(middleware.Before, newServiceMetadataMiddleware_opHttpPayloadWithXmlNamespaceAndPrefix(options.Region)); err != nil {
		return err
	}
